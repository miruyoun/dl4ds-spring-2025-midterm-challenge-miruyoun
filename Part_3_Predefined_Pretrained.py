...
################################################################################
# Part 3: Predefined Model with Pretrained Weights
################################################################################
class ResNet(nn.Module):
    def __init__(self, num_classes=100):
        super(ResNet, self).__init__()

        # Load ResNet34 without pre-trained weights
        self.model = torchvision.models.resnet34(weights=torchvision.models.ResNet34_Weights.DEFAULT)

        # Modify first convolutional layer to work better with CIFAR-100
        self.model.conv1 = nn.Conv2d(3, 64, kernel_size=3, stride=1, padding=1, bias=False)

        # Remove the default adaptive average pooling
        self.model.avgpool = nn.AdaptiveAvgPool2d((1, 1))

        # Adjusted fully connected layers with tuned dropout
...
def main():
    ...
    transform_train = transforms.Compose([
        ...
        transforms.RandomRotation(20),  # Apply random rotation within a 20 degree range
